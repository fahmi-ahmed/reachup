                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'mobile'">{{ trans('admin.user.columns.mobile') }}</th>
                                    <th is='sortable' :column="'description'">{{ trans('admin.user.columns.description') }}</th>
                                    <th is='sortable' :column="'service_type'">{{ trans('admin.user.columns.service_type') }}</th>
                                    <th is='sortable' :column="'address'">{{ trans('admin.user.columns.address') }}</th>
                                    <th is='sortable' :column="'rating'">{{ trans('admin.user.columns.rating') }}</th>
